...
function App() {
  ...
  const sendEmail = (e) => {
    e.preventDefault();
    emailjs.sendForm('service_r545dcn', 'template_yalmb0v', e.target, '21Qh_zHEBAuVtEW9x')
    .then(result => {
        ...
        <div className="row py-5 justify-content-center">
          <div className="col-md-4 bg-white p-5 mt-5">
            ...
            <form onSubmit={sendEmail}>
                ...
                <div className="form-group">
                  <input type="email"name="email" className="form-control p-3" placeholder="ایمیل شما" />
                </div>
                <div className="form-group">
                  <textarea name="message" className="form-control p-3" placeholder="پیام شما"></textarea>
                </div>
                <div className="form-group">
                  <input type="submit" className="btn btn-success w-100 p-3 text-white mt-5" value= "ارسال" />
                </div>
            </form>
          </div>
        </div>
